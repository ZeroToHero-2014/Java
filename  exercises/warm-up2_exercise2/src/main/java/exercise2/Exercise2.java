...
public class Exercise2 {
    ...
    public void addStudents(){
        ...
        System.out.println("The first list of students iterated:");
        for(Student o:mySet){
        ...
        System.out.println("The second list of students iterated:");
        mySet.addAll(studentList);
        for(Student o:mySet){
            System.out.println(o);
        }
        ...
        System.out.println("The third list of students iterated:");
        mySet.addAll(studentList);
        for(Student o:mySet){
            System.out.println(o);
        }
        ...
        for(Student o: mySet){
                ...
                myMap.put(o,cnps.get(counter));
                counter++;

        }
        System.out.println("THE EPIC LIST:"+"\n");
