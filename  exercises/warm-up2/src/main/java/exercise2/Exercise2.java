...
public class Exercise2 {
    ...
    public void addStudents(){
        ...
        // TODO (Important !) Set youP  have just already created, and in the keys' value, the CNof the Student found in cnps List
        ...
        // TODO and then the hashCode() method in order to see some differences).
         Map<Student, Long> myStudentMap = new HashMap<Student, Long>();
         int i =0;
            for(Student st : mySet){
                myStudentMap.put(st, cnps.get(i));
                i++;
            }
}
}
