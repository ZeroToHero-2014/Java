...
public class Exercise1 {
    ...
    public List<String> iteratingOverKeys(){
        ...
        Set<String> mySet=this.countries.keySet();
    ...
    public List<String> iteratingOverEntries(){
        ...
        List<String> seekingCountries = new ArrayList<String>();
        Set<Map.Entry<String,String>> mySet=this.countries.entrySet();
        for(Map.Entry<String,String> name : mySet){
            if(name.getKey().startsWith("R")==true){
    ...
    public String iteratingOverValues(){
        ...
        Collection<String> mySet=this.countries.values();

        for(String name: mySet){
            if(name.length()>seekingCapital.length()){
                seekingCapital=name;
            }
        }
