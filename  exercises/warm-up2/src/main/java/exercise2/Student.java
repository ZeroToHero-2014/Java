...
return this.firstName.equals(s.firstName) && this.lastName.equals(s.lastName) && this.averageGrade.equals(s.averageGrade);
    ...
    public int hashCode() {
            int r=0;
        r = r+ this.lastName.hashCode();
        r = r *31+ this.firstName.hashCode();
        r = r *31+ this.averageGrade.hashCode();
        r = r * 31+ 17;
        return r;
